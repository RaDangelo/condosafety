...
module.exports = {
  ...
  "entry": {
    ...
    "styles": [
      ...
      "./node_modules\\toastr\\build\\toastr.min.css",
      "./src\\styles.css"
    ]
  },
  "output": {
  ...
  "module": {
    "rules": [
      ...
      {
        "exclude": [
          path.join(process.cwd(), "node_modules\\jquery-ui-dist\\jquery-ui.min.css"),
          path.join(process.cwd(), "node_modules\\bootstrap\\dist\\css\\bootstrap.min.css"),
          path.join(process.cwd(), "node_modules\\bootstrap\\dist\\css\\bootstrap-theme.min.css"),
          path.join(process.cwd(), "node_modules\\toastr\\build\\toastr.min.css"),
